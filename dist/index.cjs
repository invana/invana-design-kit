...
var ThemeProvider = ({
  ...
  const [mode, setModeState] = React2.useState(() => {
    return readStorage(storageKey)?.mode ?? defaultMode;
  });
  const [accent, setAccentState] = React2.useState(() => {
...
var ThemeScope = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...vars, ...style }, ...rest, children });
};
...
function ThemeSwatches({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "span",
    {
      ...
      children: SWATCH_TOKENS.map((token) => /* @__PURE__ */ jsxRuntime.jsx("span", { className: ui.cn("h-3 w-3 rounded-full", token) }, token))
    }
  );
}
var MODES = [
...
var ThemeSelector = ({
  ...
  modeIcons,
  themes: themeList = themes_config.themes,
  accents = DEFAULT_ACCENTS,
  labels,
  className,
  ...
  const [iTheme, setITheme] = React2.useState(defaultTheme);
  const [iMode, setIMode] = React2.useState(defaultMode);
  const [iAccent, setIAccent] = React2.useState(defaultAccent);
  ...
  React2.useEffect(() => {
    ...
    themes_config.applyTheme(themes_config.getThemeVariantById(id) ? id : "default-light");
  ...
  const themeOptions = React2.useMemo(
  ...
  const themeCards = /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(
    ui.ToggleGroup,
    {
      type: "single",
      value: theme,
      ...
      children: themeList.map((t) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.Tooltip, { delayDuration: 300, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
            ui.ToggleGroupItem,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(ThemeSwatches, { themeId: t.id, isDark }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-0.5 text-meta font-medium", children: t.name }),
                selected && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "absolute -right-1.5 -top-1.5 flex h-4 w-4 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-sm", children: /* @__PURE__ */ jsxRuntime.jsx(CheckMark, { className: "h-2.5 w-2.5" }) })
              ]
            }
          ) }),
          t.description != null && /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipContent, { children: t.description })
        ] }, t.id);
      })
    }
  ) });
  const themeSelect = /* @__PURE__ */ jsxRuntime.jsx(
    ui.RichSelect,
    {
      label: themeLabel,
      ...
      renderOption: (option) => /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex w-full items-center gap-3 py-0.5", children: [
        /* @__PURE__ */ jsxRuntime.jsx(ThemeSwatches, { themeId: option.value, isDark }),
        /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex min-w-0 flex-col", children: [
          ...
          option.description != null && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "line-clamp-1 text-meta text-muted-foreground", children: option.description })
        ] })
      ] }),
      renderValue: (selected) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex min-w-0 items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntime.jsx(ThemeSwatches, { themeId: only.value, isDark, className: "p-0.5" }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "truncate", children: only.label })
        ] });
      }
    }
  );
  const themeField = showTheme && /* @__PURE__ */ jsxRuntime.jsx(Field, { stacked, label: stacked ? themeLabel : void 0, inlineLabel: !stacked ? themeLabel : void 0, children: resolvedThemeVariant === "cards" ? themeCards : themeSelect });
  const modeField = showMode && /* @__PURE__ */ jsxRuntime.jsx(Field, { stacked, label: stacked ? modeLabel : void 0, inlineLabel: !stacked ? modeLabel : void 0, children: /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(
    ui.ToggleGroup,
    {
      type: "single",
      value: mode,
      ...
      children: MODES.map(({ value, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.Tooltip, { delayDuration: 0, children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(ui.ToggleGroupItem, { value, "aria-label": label, children: Icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "px-1 text-meta", children: label }) }) }),
          /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipContent, { children: label })
        ] }, value);
      })
    }
  ) }) });
  const accentField = showAccent && /* @__PURE__ */ jsxRuntime.jsx(Field, { stacked, label: stacked ? accentLabel : void 0, inlineLabel: !stacked ? accentLabel : void 0, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Separator, { orientation: "vertical", className: "h-6" }),
    accents.map((a) => {
  ...
  if (stacked) {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cn("flex flex-col gap-5", className), children: [
      themeField,
      modeField,
      accentField
    ] });
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cn("flex flex-wrap items-center gap-4", className), children: sections.map((section, i) => /* @__PURE__ */ jsxRuntime.jsxs(React2__default.default.Fragment, { children: [
    i > 0 && /* @__PURE__ */ jsxRuntime.jsx(ui.Separator, { orientation: "vertical", className: "h-6" }),
    section
  ] }, i)) });
};
var Field = ({ stacked, label, inlineLabel, children }) => {
  if (stacked) {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col gap-2", children: [
      label && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "font-medium", children: label }),
      children
    ] });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
    inlineLabel && /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "text-muted-foreground", children: [
      inlineLabel,
      ":"
    ] }),
    children
...
var ThemeSettingsCardInner = ({
  ...
  const ctx = useTheme();
  const [baseline, setBaseline] = React2.useState(() => ({
    theme: ctx.theme,
    mode: ctx.mode,
    accent: ctx.accent
  }));
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Card, { className, children: [
    header != null && /* @__PURE__ */ jsxRuntime.jsx(ui.CardHeader, { children: renderSlot(header, state) }),
    /* @__PURE__ */ jsxRuntime.jsx(ui.CardContent, { className: ui.cn("space-y-6", contentClassName), children: /* @__PURE__ */ jsxRuntime.jsx(ThemeSelector, { layout: "form", ...selectorProps }) }),
    footer != null && /* @__PURE__ */ jsxRuntime.jsx(ui.CardFooter, { children: renderSlot(footer, state) })
  ] });
};
var ThemeSettingsCard = ({
  ...
  if (existing) return /* @__PURE__ */ jsxRuntime.jsx(ThemeSettingsCardInner, { ...rest });
  return /* @__PURE__ */ jsxRuntime.jsx(
    ThemeProvider,
    {
      defaultTheme,
      ...
      persist: "manual",
      children: /* @__PURE__ */ jsxRuntime.jsx(ThemeSettingsCardInner, { ...rest })
    }
  );
};
var ThemeSettingsActions = ({
  ...
  resetLabel = "Reset",
  className
}) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cn("flex w-full items-center justify-end gap-2", className), children: [
  /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { variant: "ghost", size: "sm", onClick: state.reset, disabled: !state.isDirty, children: resetLabel }),
  /* @__PURE__ */ jsxRuntime.jsx(ui.Button, { size: "sm", onClick: state.save, disabled: !state.isDirty, children: saveLabel })
] });
...
var AppLayoutBase = (props) => {
  return /* @__PURE__ */ jsxRuntime.jsx(ui.TooltipProvider, { delayDuration: 0, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: utils.cn("flex h-screen flex-col  bg-background text-foreground", props.className), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.NavHorizontal,
      {
        className: utils.cn("h-[40px] border-b border-border", CHROME_SURFACE, props.header.className),
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: utils.cn("flex-1 min-h-0 w-full bg-background", props.mainClassName), children: props.main }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.NavHorizontal,
      {
        className: utils.cn("h-[25px] border-t border-border", CHROME_SURFACE, props.footer.className),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    AppLayoutBase,
    {
      ...
      main: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "relative h-full flex flex-1", children: [
        showLeftNav && /* @__PURE__ */ jsxRuntime.jsx(
          ui.NavVertical,
          {
            className: utils.cn("border-r", CHROME_SURFACE, props.leftNav?.className),
...
var AppLayoutV2 = ({
  ...
  const generatedId = React2__default.default.useId().replace(/:/g, "");
  const ns = idPrefix ?? `app-v2-${generatedId}`;
  const panelId = (name) => `${ns}-${name}`;
  const sidebarPanel = leftSection ? /* @__PURE__ */ jsxRuntime.jsx(
    ui.ResizablePanel,
    {
  ...
  const rightPanel = rightSection ? /* @__PURE__ */ jsxRuntime.jsx(
    ui.ResizablePanel,
    {
  ...
  const bottomPanel = bottomSection ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.ResizableHandle, { withHandle: true }),
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.ResizablePanel,
      {
  ...
  const editorPanel = /* @__PURE__ */ jsxRuntime.jsx(
    ui.ResizablePanel,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-full overflow-auto bg-card", children: mainSection.content })
    }
  );
  const renderEditorRow = (includeLeft, includeRight) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.ResizablePanelGroup, { orientation: "horizontal", id: panelId("editor-horizontal"), children: [
      withLeft && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        sidebarPanel,
        /* @__PURE__ */ jsxRuntime.jsx(ui.ResizableHandle, { withHandle: true })
      ] }),
      editorPanel,
      withRight && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.ResizableHandle, { withHandle: true }),
        rightPanel
      ] })
    ] });
  };
  const editorWithBottom = (includeLeft, includeRight, groupId) => /* @__PURE__ */ jsxRuntime.jsxs(ui.ResizablePanelGroup, { orientation: "vertical", id: panelId(groupId), children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      ui.ResizablePanel,
      {
  ...
  let layout;
  if (bottomSpan === "full") {
    layout = /* @__PURE__ */ jsxRuntime.jsxs(ui.ResizablePanelGroup, { orientation: "vertical", id: panelId("main-layout"), children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ui.ResizablePanel,
        {
          id: panelId("editor-area"),
    ...
    layout = /* @__PURE__ */ jsxRuntime.jsxs(ui.ResizablePanelGroup, { orientation: "horizontal", id: panelId("main-layout"), children: [
      sidebarPanel && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        sidebarPanel,
        /* @__PURE__ */ jsxRuntime.jsx(ui.ResizableHandle, { withHandle: true })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx(
      ...
      rightPanel && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.ResizableHandle, { withHandle: true }),
        rightPanel
      ] })
    ] });
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    AppLayoutV1,
    {
      ...
      main: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex-1 h-full", children: layout })
    }
  );
};
...
exports.CHROME_SURFACE = CHROME_SURFACE;
exports.DEFAULT_ACCENTS = DEFAULT_ACCENTS;
exports.ThemeProvider = ThemeProvider;
exports.ThemeScope = ThemeScope;
exports.ThemeSelector = ThemeSelector;
exports.ThemeSettingsActions = ThemeSettingsActions;
exports.ThemeSettingsCard = ThemeSettingsCard;
exports.accentVars = accentVars;
exports.findAccent = findAccent;
